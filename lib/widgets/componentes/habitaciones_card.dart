...
class HabitacionesComp extends StatelessWidget {
  final int size;
  final Color color;
            ...
            child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const HabitacionesScreen()),
                  );
                },
                child: Card(
                    ...
                    child: Column(children: [
                      Padding(
                          padding: EdgeInsets.only(top: paddingIconoArriba)),
                      Icono(
                          color: color,
                          iconColor: iconColor,
                          icon: Icons.bed,
                      ...
                      SubTitulo(
                          ...
                          subTitulo: dormitorios.toString() +
                              " Dormitorios\n" +
                              camas.toString() +
                              " Camas"),
